...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href="#nogo">View all products</a></li>
...
<div id="content">
	...
	?>
				<tr <?=($even)?('class="alternate-row"'):('')?>>
					...
					<td valign="top"><?=$projet->prjlbnom?></td> 
			<td valign="top"><?=$projet->prjtxdes?></td> 
					<td class="options-width">
					<a href="<?=base_url()?>index.php/editprojet/index/<?=$projet->prjidprj?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="<?=base_url()?>index.php/listprojets/delete/<?=$projet->prjidprj?>" title="Delete" class="icon-2 info-tooltip"></a>
					</td>
				</tr>
	<?php 
		$even = !$even; 
...
$fields_info = array();
echo form_open_multipart('listprojets/add', $attributes_info, $fields_info );
?>
		<!-- start id-form -->
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<!-- list of variables - auto-generated : -->
		<tr><td><label title="Libellé du projet" for="prjlbnom">Nom</label> : </td><td><input type="text" name="prjlbnom" id="prjlbnom" class="inp-form-error"></td><td><div class="error-left"></div><div class="error-inner">This field is required.</div></td></tr>
		<tr><td><label title="Description globale de l'objectif à atteindre" for="prjtxdes">Description</label> : </td><td><input type="text" name="prjtxdes" id="prjtxdes" class="inp-form"></td><td></td></tr>
