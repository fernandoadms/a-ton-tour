...
$fields_info = array('prjidprj' => $projet->prjidprj);
echo form_open_multipart('editprojet/save', $attributes_info, $fields_info );
?>
		<!-- list of variables - auto-generated : -->
		<tr><td><label title="Libellé du projet" for="prjlbnom">Nom</label> : </td><td><input type="text" name="prjlbnom" id="prjlbnom" class="inp-form-error" value="<?= $projet->prjlbnom ?>" ></td><td><div class="error-left"></div><div class="error-inner">This field is required.</div></td></tr>
		<tr><td><label title="Description globale de l'objectif à atteindre" for="prjtxdes">Description</label> : </td><td><input type="text" name="prjtxdes" id="prjtxdes" class="inp-form" value="<?= $projet->prjtxdes ?>" ></td><td></td></tr>
		<tr>
			<td></td>
			<td>
				<input type="submit" value="" class="form-submit" />
				<input type="button" value="" class="form-retour"
					onclick="document.location.href='<?=base_url()?>index.php/listprojets';return false;" />
			</td>
		</tr>
	</table>
