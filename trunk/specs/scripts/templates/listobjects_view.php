...
<div class="container">  
	<div id="header">
		...
		<div class="span-12"><h2><img src="<?=base_url()?>www/images/%(name_lower).png" style="vertical-align:middle;"> Liste des %(name_lower)s</h2></div>
...
<hr>
<fieldset>
	<legend><img src="<?=base_url()?>www/images/plus_16.png"> Ajouter un %(Name)</legend>
